...
function IconPhone() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path
        d="M16.629 13.891L17.085 13.438L16.026 12.374L15.572 12.827L16.629 13.891ZM18.606 18.218C17.156 18.354 13.406 18.233 9.344 14.195C5.473 10.345 4.831 7.108 4.751 5.703C4.732 5.358 4.891 4.996 5.221 4.668L4.163 3.604C3.625 4.138 3.202 4.894 3.253 5.788C3.353 7.556 4.148 11.144 8.286 15.258C12.718 19.665 16.937 19.881 18.746 19.712C19.481 19.643 20.082 19.273 20.53 18.828L19.472 17.764C19.198 18.038 18.902 18.192 18.606 18.218Z"
        fill="#161616"
      />
      <path d="M9.974 2.41L8.773 3.31L10.033 4.993L11.234 4.094L9.974 2.41Z" fill="#161616" />
    </svg>
  );
}
